  ...
  return (
    <div className="p-6">
      ...
      <form onSubmit={handleSubmit} encType="multipart/form-data" className="max-w-lg space-y-4">
        ...
        <div>
          <label className="block mb-1">Images (up to 5)</label>
        ...
        <button type="submit" className="bg-blue-500 text-white px-4 py-2 rounded hover:bg-blue-600">Create Product</button>
      </form>
    </div>
  );
};
